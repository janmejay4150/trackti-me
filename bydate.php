...
<?php
	...
	echo "<div>";
	echo "<h3>Details for ".ucwords($_POST['userdetail'])." on ".date('d-M-Y',strtotime($_POST['dt']))."</h3>";
	echo "<br />";
	...
	$para="id";
	$table="login";
	$getid=$db->selectdb($table,$para,$where);

	$table1= "tasks";
	$parameters1= "eid,taskname,t_start,t_end,pid,notes,client";
	$where1= "t_date='".$date."' and eid=".$getid['id']." AND status=1";
