...
<div class="container-fluid">
  ...
  <div class="nav-collapse">
	<ul class="nav" role="navigation">
		...
		<li class="active"><a href="guesthome.php">Timesheet</a></li>
	</ul>
  </div><!--/.nav-collapse -->
</div>
</div>
...
<div class="alert alert-error" id="form_error" style="display:none;"><a href='#' class='close' data-dismiss='alert'>×</a><b></b></div>
		<form class="form-horizontal" name="change" method="POST" action="changepwd.php" onsubmit="return check(currpwd.value,newpwd.value,cnewpwd.value);">
<?php
		if(isset($_GET['msg1']))
		{                
			$a=$_GET['msg1'];
...
?>
			...
			<input type="password" name="newpwd" placeholder="New Password">
			 ...
			 <div class="control-group">
		      ...
		      <div class="controls">
			<input type="password" name="cnewpwd" placeholder="Retype Password">
		      </div>
		    </div><br />
		    <div class="control-group">
		      <div class="controls">
