...
?>
	...
	function getpro(str)
	{
		...
		$.post("getpro.php",data,function(response){ //alert(response);
...
?> 			
		...
		<div class="span3">
			<div class="row-fluid well">
				...
				<form name="bydate" method="POST" action="userhome.php" onsubmit="return ValidateForm();">
			...
			<form name= "taskinfo" method="POST" action= "inserttask.php" onsubmit="return checkform(start.value,end.value,project.value);">
				<div align= "left">
