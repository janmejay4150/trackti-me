...
?>
<strong><h4><div style = "color: red;background-color:#F2DEDE;display:none;width:250px;padding:5px;border-radius:5px;" id = "form_error"> </div></h4></strong>
<form class="form-horizontal" name="addproj" method="POST" action="addpro.php" onsubmit="return check(project.value);">
	...
	<div id = "clientinfo" name = "clientinfo">
		Name:<br/><input type = "text" name = "cname" id = "cname" autocomplete = "true" required = "required"/><br/>	
		Address:</br><textarea rows = "3" cols = "5" name = "caddress"></textarea><br/>
		City:<br/><input type = "text" name = "city"/><br/>
		State:<br/><input type = "text" name = "state"/><br/>
		Postal Code:<br/><input type = "text" name = "postcode" /><br/>
		Phone:<br/><input type = "text" name = "cph" required = "required"/><br/>
		Fax:<br/><input type = "text" name = "fax" /><br/>
		Email:<br/><input type = "text" name = "cmail" required = "required"/><br/>
...
<div class="row-fluid well">
				...
				<p><strong><a href="admin_addpro.php" >Add a Project</a></strong></p>
