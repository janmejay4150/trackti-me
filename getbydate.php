...
<?php
	...
	<div class="accordion-group" id = "<?php echo $acin;?>">
		...
		<div class="row-fluid show-grid">
			<div class="span1" style = "padding-top:9px;">
			<a href="useredit.php?id=<?php echo base64_encode($var['id']); ?>" ><i class="icon-edit"></i></a>&nbsp;&nbsp;
			<a href="deletetask.php?did=<?php echo base64_encode($var['id']); ?>"><i class="icon-trash"></i></a>
		</div>
	...
	echo "<ul class='pager'>";
    	echo "<li>";
    	echo "<a href='userhome.php?dt=".$previous."'>Previous</a>";
    	echo "</li>";
    	echo "<li>";
    	echo "<a href='userhome.php?dt=".$next."'>Next</a>";
    	echo "</li>";
    	echo "</ul>";
 	echo "</div>";
?>
